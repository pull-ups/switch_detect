...
import os
#val_image_dir = './switch_data_v1/images/val'
#val_label_dir = './switch_data_v1/labels/val'
val_image_dir = './switch_data_v1/images/test'
val_label_dir = './switch_data_v1/labels/test'
save_dir = './runs/detect/train3/test_results'
...
for val_image_name in os.listdir(val_image_dir):
    ...
    val_label_path = os.path.join(val_label_dir, val_image_name.replace('.jpg', '.txt'))
